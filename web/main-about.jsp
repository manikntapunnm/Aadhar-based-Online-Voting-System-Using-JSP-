<%-- 
    Document   : main-about
    Created on : 05-Aug-2023, 10:40:38 am
    Author     : manikanta
--%>
...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="main-about.jsp" class="nav-item nav-link active">About</a>
        ...
        <div class="container-xxl" >
            <h1 class="text-center" style="margin-bottom: 70px; margin-top:-30px; text-decoration:underline;">About Us</h1>
            <div class="container">
