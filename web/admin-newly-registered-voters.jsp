<%-- 
    Document   : admin-manage-voters
    Created on : 05-Aug-2023, 10:39:04 am
    Author     : manikanta
--%>
...
String countQuery = "SELECT COUNT(*) AS total FROM voters WHERE action = 'Pending'";
    ...
    String sql = "SELECT * FROM voters WHERE action = 'Pending' LIMIT ?, ?";
...
%>
            ...
            <div class="col-sm-12 col-xl-12 mt-5 text-center">
                <div class="bg-light rounded h-100 p-4">
                    <h5 class="mb-4">Manage Newly Registered Voter:</h5>
        ...
        if (imageBlob != null) {
            imageData = imageBlob.getBytes(1, (int) imageBlob.length());
                    ...
                    %>
                            ...
                            <tr>
                                <th scope="row"><%= sNo++ %></th>
                                <!--td><img src="img/portrait-white-man-isolated.jpg"
                                        style="border-radius:40%; width:50px;" /></td-->
    ...
    <div class="btn-group" role="group">
        <form action="updateaction_3.jsp" method="post">
            <input type="hidden" name="id" value="<%= resultSet.getString("id") %>">
            <button type="submit" class="btn btn-outline-success btn-sm btn-icon-text" name="action" value="Accepted">
                Allow
        ...
        <form action="updateaction_3.jsp" method="post">
            <input type="hidden" name="id" value="<%= resultSet.getString("id") %>">
            <button type="submit" class="btn btn-outline-warning btn-sm btn-icon-text" name="action" value="Blocked">
                Block
                <i class="typcn typcn-delete-outline btn-icon-append"></i>
            </button>
        </form>
        <form action="removeaction_3.jsp" method="post">
            <input type="hidden" name="id" value="<%= resultSet.getString("id") %>">
            <button type="submit" class="btn btn-outline-danger btn-sm btn-icon-text" name="action" value="Rejected">
