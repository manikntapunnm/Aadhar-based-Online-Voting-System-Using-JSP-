<%-- 
    Document   : main-contact
    Created on : 05-Aug-2023, 10:40:54 am
    Author     : manikanta
--%>
...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="main-contact.jsp" class="nav-item nav-link active">Contact</a>
                    </div>
                </div>
            </nav>
        ...
        <div class="container-xxl d-flex">
            <div class="card col-5" style="margin-left: 20px;margin-right: 20px">
                <h5>Maps:</h5>
                <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d2978.835482195634!2d82.02281448956985!3d16.749790851627953!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTbCsDQ1JzAwLjIiTiA4MsKwMDEnMjUuOSJF!5e0!3m2!1sen!2sin!4v1675423788450!5m2!1sen!2sin"  height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>        
            </div>
            <div class="container card col-6 "style='margin-right: 0px'>
