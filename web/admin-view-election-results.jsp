<%-- 
    Document   : admin-view-election-results
    Created on : 05-Aug-2023, 10:39:53 am
    Author     : manikanta
--%>
...
%>
            <div class=" col-12 mt-5">
                <div class="bg-light rounded h-100 p-4">
                    <h5 class="mb-4">Election Results:</h5>
                    <table class="table table-hover text-center">
                        <thead>
                            <tr>
                                <th>S.No</th>
                                <th>Election Name</th>
                                <th>Head of Election</th>
    ...
    String results = resultSet.getString(13);
