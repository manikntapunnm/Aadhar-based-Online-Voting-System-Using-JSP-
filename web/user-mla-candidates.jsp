<%-- 
    Document   : user-mla-canditates
    Created on : 05-Aug-2023, 10:43:01 am
    Author     : manikanta
--%>
...
// Retrieve specific voteURL and sessionVoteURL values based on the election type (e.g., mla)
...
try {
    ...
    if (mlaResultSet.next()) {
        ...
        String constituency = mlaResultSet.getString("constituency");
...
%>   
       ...
       <div class="col-6 d-flex m-auto">
            ...
            <h3>Election Name:</h3>
            <h5 class="mx-4 my-2"><%= mlaName %> Elections</h5>
        </div>
        <div class="d-flex text-center">
            <h3>Constituency:</h3>
        ...
        <div class="row">
                <div class="d-flex text-center">
                    <h3>Date:</h3>
                    <h5 class="mx-4 my-2"><%= mlaDate %></h5>
                </div>
                <div class="d-flex text-center">
                    <h3>Candidates:</h3>
                    <h5 class="mx-4 my-2"><%= mlaCandidates %></h5>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12 tablebg">
                    <div class="card text-center">
                        <div class="table-responsive">
                            ...
                            candidatesStatement.setString(1, mlaName);
