...
<%--
String voteURL = (String) request.getSession().getAttribute("voteURL");
String sessionVoteURL = (String) request.getSession().getAttribute("sessionVoteURL");
--%>
...
%>
          ...
          <%
// Retrieve the electionUrlsMap from the session
Map<String, String[]> electionUrlsMap = (Map<String, String[]>) session.getAttribute("electionUrlsMap");

// Retrieve specific voteURL and sessionVoteURL values based on the election type (e.g., GHMC)
String[] urlss = electionUrlsMap.get(ename);
String voteURL = urlss[0];
String sessionVoteURL = urlss[1];
        ...
        <ul class="sub-menu">
            <li>
                ...
                <p>Voter ID: <%= session.getAttribute("voterid") %></p>
                    ...
                    <%--p>GHMC Election Name: <%= session.getAttribute("Name") %></p--%>
...
try {
    ...
    String Sql = "SELECT * FROM elections WHERE ename = ?";
    String ElectionName = ename;
    ...
    if (ResultSet.next()) {
       // String Name = ResultSet.getString("ename");
        ...
        int Candidates = ResultSet.getInt("candidates");
...
%>   
       ...
       <div class="col-6 d-flex m-auto">
        ...
        <div class="row">
                <div class="d-flex text-center">
                    <h4>Date:</h4>
                    <h5 class="mx-4 my-2"><%= Date %></h5>
                </div>
                <div class="d-flex text-center">
                    <h3>Candidates:</h3>
                    <h5 class="mx-4 my-2"><%= Candidates %></h5>
                </div>
            </div>
        </div>
...
%>
        ...
        <tr>
                                        ...
                                        <td>
                                                ...
                                                <a href="vote-verify.jsp?pname=<%= pname %>&ename=<%=ename%>&cname=<%=cname%>&voteURL=<%=voteURL%>&sessionVoteURL=<%=sessionVoteURL%>">
