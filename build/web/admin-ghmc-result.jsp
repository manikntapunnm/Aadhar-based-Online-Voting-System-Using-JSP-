<%-- 
    Document   : admin-ghmc-result
    Created on : 05-Aug-2023, 10:38:22 am
    Author     : manikanta
--%>
            ...
            <div class="container">
                <div class="col-12">
                    <div class="row card mt-5">
                        <h2 class="d-flex my-5">GHMC Election Results</h2>
                        <div class="col-8 mx-5">
                            <canvas id="myChart"></canvas>
                        </div>
                        <script>
                            var xValues = ["TDP", "YSRCP", "Janasena", "TRS"];
                            var yValues = [54, 47, 22, 36, 0];
                            var barColors = ["yellow", "skyblue", "red", "pink"];
                        ...
                        <a href="admin-graph-analysis.jsp" class="text-center my-5">Go back</a>
                    </div>
                </div>
            </div>
