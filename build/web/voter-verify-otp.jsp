...
<head>
    ...
    <script>
        function myFunction() {
        alert("Your Vote was Successfully Submited");
        }
    </script>
    <style>
        .otp-input-wrapper {
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0">
           ...
           <%-- <p>Election: <%= session.getAttribute("ename") %></p><br><p>Candidate: <%= session.getAttribute("cname") %></p><br><p>Party: <%= session.getAttribute("pname") %></p>--%>
        </div>
        <!-- Navbar & Hero End -->
        <style>
...
%>
    ...
    <div class="card-body align-items-center text-center"><br>
        <div class="otp-input-wrapper">
            ...
            <form  action="otp-validate.jsp?pname=<%= pname %>&ename=<%=ename%>&cname=<%=cname%>" method="post" id="otp-form">
                <h6>OTP has sent to  <p class="moving-element"><%= session.getAttribute("phone") %></p></h6>
