    ...
    <li  class="nav-item"><i style="color:white; "  class="bi bi-list"></i>
        ...
        <ul class="sub-menu">
            <li>
                ...
                <p>ename: <%= session.getAttribute("ename") %></p>
...
session.setAttribute("ename2", ename);
%>
...
<%
    ...
    try {
        ...
        String sql = "SELECT cname, pname, ename FROM candidates WHERE ename = ? AND votes = (SELECT MAX(votes) FROM candidates WHERE ename = ?)";
        PreparedStatement preparedStatement = conn.prepareStatement(sql);
        
        // Set the ename parameter values
...
<div class="col-10 mt-5  style='margin-top: 0;' m-auto scrolling-text">
    <div class="row">
        <div class="card text-center" style="box-shadow: 1px 0px 8px 0px rgb(94, 230, 89);">
            ...
            <h6 class="mt-1 "> <i>Winner</i> of the Elections is <i style="color:orange; "  class="bi bi-star  vote-rotation"></i><i class=  "vote-animation"><%= cname%></i><i style="color:orange; "  class="bi bi-star  vote-rotation"></i> from<p class=  "vote-animation"> <%= pname%></p></h6>
        </div>
    </div>
</div>
<%
...
%>    
   ...
   <div class="col-10 mt-5 m-auto">
        <div class="row">
            <div class="card text-center" style="box-shadow: 1px 0px 8px 0px rgb(94, 230, 89);">
                <h2 class="d-flex my-5"><%= ename%> Election Results</h2>
...
<script>
    ...
    fetch('getChartData.jsp')
        ...
        .then(data => {
            ...
            var numberOfColors = 2000; // Set the number of colors you want
var barColors = randomColor({ count: numberOfColors });
            ...
            var yAxisUpperLimit = 6000000000000000000000000000; // Adjust the value as needed
