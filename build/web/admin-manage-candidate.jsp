<%-- 
    Document   : admin-manage-candidate
    Created on : 05-Aug-2023, 10:38:42 am
    Author     : manikanta
--%>
...
%>
    ...
    <div class="col-12 mt-5">
        <div class="bg-light rounded h-100 p-4">
            <h6 class="mb-4">Manage Candidate:</h6>
            <table class="table table-hover text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="getImage.jsp?id=<%= resultSet.getString(1) %>" alt="<%= resultSet.getString("cname") %> image" style="width:50px;"></td>
