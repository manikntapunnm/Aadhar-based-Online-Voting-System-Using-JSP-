<%-- 
    Document   : admin-mlc-result
    Created on : 05-Aug-2023, 10:39:27 am
    Author     : manikanta
--%>
            ...
            <div class="container">
                <div class="col-12">
                    <div class="row card mt-5">
                        <h2 class="d-flex my-5">MLC Election Results</h2>
                        <div class="col-8 mx-5">
                            <canvas id="myChart"></canvas>
                        </div>
                        <script>
                            var xValues = ["TDP", "YSRCP"];
                            var yValues = [42, 53, 0];
                            var barColors = ["yellow", "skyblue"];
