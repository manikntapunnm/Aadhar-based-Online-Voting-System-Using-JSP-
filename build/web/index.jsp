<%-- 
    Document   : index
    Created on : 05-Aug-2023, 10:33:59 am
    Author     : manikanta
--%>
...
<body>
    <div class="container-xxl bg-white">
        ...
        <div class="container-xxl ">
            <nav class="navbar navbar-expand-lg navbar-light px-lg-5 py-3 py-lg-0">
                <a href="index.jsp" class="navbar-brand p-0">
                    <h1 class="m-0">Vote for Change</h1>
                ...
                <div class="container">
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated zoomIn mx-3">Voting</h1>
                            <p class="text-white pb-3 animated zoomIn mx-3">
                                Voting is one of the processes that allow citizens to find their place in society,
                                as well as one of the rights to elect a worthy and modest leader.
                                There are a lot of voting syatems that aren't secure,
                                therefore by incorporating the blockchain, security is ensured.
                                Verification of Adhar is used to create a digitial signature has a significant role to
                                play.
                            </p>
                            <a href=""
                                class="btn btn-outline-light rounded-pill border-2 py-3 px-5 animated slideInRight mx-3">Learn
                                More</a>
                        </div>
                        <div class="col-lg-6 text-center text-lg-start">
                            <img class="img-fluid animated zoomIn mr-5" src="img/4585-removebg-preview.png"
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow zoomIn" data-wow-delay="0.1s">
                        <img class="img-fluid" src="img/4448.jpg">
                    </div>
        ...
        <div class="container-xxl py-6">
            <div class="container">
                <div class="mx-auto text-center wow fadeInUp" data-wow-delay="0.1s" style="max-width: 25em;">
        ...
        <div class="container-xxl py-6">
            <div class="container">
                <div class="mx-auto text-center wow fadeInUp" data-wow-delay="0.1s" style="max-width: 25rem;">
