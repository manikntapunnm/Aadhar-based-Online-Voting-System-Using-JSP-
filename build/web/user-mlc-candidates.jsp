<%-- 
    Document   : user-sae-canditates
    Created on : 05-Aug-2023, 10:43:27 am
    Author     : manikanta
--%>
...
// Retrieve specific voteURL and sessionVoteURL values based on the election type (e.g., mlc)
String[] urls= electionUrlsMap.get(ename);
String voteURL = urls[0];
String sessionVoteURL = urls[1];
        ...
        <ul class="sub-menu">
            <li>
                ...
                <p>Voter ID: <%= session.getAttribute("voterid") %></p>
                    ...
                    <%--<p>MLC Election Name: <%= session.getAttribute("mlcEname") %></p>--%>
...
try {
    ...
    if (mlcResultSet.next()) {
        ...
        String constituency = mlcResultSet.getString("constituency");
...
%>   
       ...
       <div class="col-6 d-flex m-auto">
        ...
        <div class="row">
                <div class="d-flex text-center">
                    <h3>Date:</h3>
                    <h5 class="mx-4 my-2"><%= mlcDate %></h5>
                </div>
                <div class="d-flex text-center">
                    <h3>Candidates:</h3>
                    <h5 class="mx-4 my-2"><%= mlcCandidates %></h5>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12 tablebg">
                    <div class="card text-center">
                        <div class="table-responsive">
                            ...
                            candidatesStatement.setString(1, mlcName);
